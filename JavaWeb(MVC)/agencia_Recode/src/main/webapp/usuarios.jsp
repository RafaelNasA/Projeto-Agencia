...
<body class="text-center">
	...
	<a href="./cadastroUsuario.jsp" class="btn btn-primary mb-5">Criar novo</a>
			...
			<tbody>
				<c:forEach items="${usuario}" var="usuarios">
					<tr>
						...
						<td>
							<a href="UpdateControllerUsuario?id=${usuarios.id}" class="btn btn-success">Editar</a>
							<a href="DeleteControllerUsuario?id=${usuarios.id}"
